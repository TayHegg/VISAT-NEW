...
vm.runInNewContext(`${source.slice(start, end)}; globalThis.result = { codes: PRODUCAO_SIA_SUS_CODES, total: producaoTotal, codesFrom: producaoCodes, summary: producaoSummaryByCode, filtered: producaoFilteredItems, latestMonth: producaoLatestMonth };`, sandbox);
